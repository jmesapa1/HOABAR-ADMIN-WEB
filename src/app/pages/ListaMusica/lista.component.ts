...
export class ListaComponent implements OnInit {
  ...
  modoDj
  estadoServicio
  constructor(private http: HttpClient, private authService: AuthService, private router: Router, private firestoreService: FirestoreService, private route: ActivatedRoute, private utils: UtilsService, private clienteService: ClienteService, private alertService: AlertService, private modalService: NgbModal) {
    this.obtenerDevices()
  }
  ...
  ActivarInactivarServicio(){
    this.firestoreService.cambiarEstadoServicio(!this.estadoServicio).then(x=>{
      if(!this.estadoServicio===true){
        this.alertService.crearMensaje("success", "Se ha deshabilitado el servicio")

      }else{
        this.alertService.crearMensaje("success", "Se ha habilitado el servicio")
